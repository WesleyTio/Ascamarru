...
<div class="container" style="margin-top: 20px">
    ...
    <form action="{{ route('admin.tips.save') }}" method="POST" autocomplete="on" >
        @csrf
        <div class="form-group">
            <label for="exampleInputTitile">Título</label>
            <input type="text" name="tip_title" class="form-control" id="inputName" placeholder="">
        </div>
        <div class="form-group">
        ...
        <div class="input-group">
            <div class="col-md-6 mb-3">
                <img id="imageTip" src="{{ asset('storage/img/reclycle_tip.jpg') }}"  name="foto_url" class="img-thumbnail img-fluid" >
            </div>
           <div class="col-md-6 mb-3">
